...
-(void)didMoveToWindow{
  %orig;
  self.textField.textColor = [prefs colorForKey:@"textTint"];
}
%end

//Fix black text in tweaks
...
-(void)didMoveToWindow{
  %orig;
  MSHookIvar<UITextField*>(self, "_editableTextField").textColor = [prefs colorForKey:@"textTint"];
}
%end
//Fix Name Colors
